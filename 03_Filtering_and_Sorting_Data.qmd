...
We can also return just the few rows using `head()`. It returns the first 6 rows by default 
...
Always use the double equals to mean equal 
...
In this case it means less than or equal to 
...
-   How about the five lowest? Asceding is by default. 
